<%@ Page Language="VB" AutoEventWireup="false" CodeFile="regit.aspx.vb" Inherits="regit" %>
                        ...
                        <table class="loginForm" cellspacing="0" cellpadding="4" border="0">
                            <tr>
                                <td colspan="2" class="blackshade" align="center">
                                    <strong><font size="+1">ลงทะเบียนเข้าใช้งาน</font></strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 192px">
                                    &nbsp;<asp:TextBox ID="tb_pea_id" runat="server" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td valign="top" align="right" class="style2">
                                    สังกัด.:&nbsp;</td>
                            ...
                            <tr>
                                <td align="center" colspan="2" style="height: 28px">
                                    &nbsp;
                                    <asp:Button ID="cmdLogin" runat="server" CssClass="buttonM" Text="ลงทะเบียน" CausesValidation="False"></asp:Button>&nbsp;</td>
                            </tr>
                        </table>
                        <p>
